...
End Sub
```
## Running Analysis for Any Year
Adding in the code below activates a prompt when we run the analysis. It asks which year we want the analysis to run for. When we enter the year (i.e. 2018), that becomes the value of "yearValue." \
```vba
yearValue = InputBox("What year would you like to run the analysis on?")
```
With this, you have to change all variables in the initial code that have the year in it.
## Full Analysis Macros Below:
```vba
Sub AllStocksAnalysis()
...
yearValue = InputBox("What year would you like to run the analysis on?")
    ...
    For i = 0 To 11
        ...
        '5) loop through rows in the data
        Worksheets(yearValue).Activate 'activate data worksheet for inner for loop
        For j = 2 To RowCount
            '5a) Get total volume for current ticker - use DQAnalysis code, but modify for j iterator
            If Cells(j, 1).Value = ticker Then
...
```
# Challenge
For this analysis, this Macros helps Steve automate the data for his financial analysis for any year and any stock on the list. This new analysis allows Steve to be more efficient and allows the code to run very quickly. \
I've included my code below.\

I believe I was supposed to create an array based on any stocks that Steve would have, but I couldn't figure out how to create that code.
...
yearValue = InputBox("What year would you like to run the analysis on?")
    ...
    Dim startingPrice As Variant
    Dim endingPrice As Variant
